...
MEMORY
    {
    FLASH (rx) : ORIGIN = 0x1000, LENGTH = 0xd4000
    SRAM (wx) : ORIGIN = 0x20000400, LENGTH = 0x3fc00
    ...
    IDT_LIST (wx) : ORIGIN = (0x20000400 + 0x3fc00), LENGTH = 2K
    }
ENTRY("__start")
SECTIONS
    {
 ...
 *(".kernel_noinit.*")
    ...
    _image_ram_end = .;
    _end = .;
    __kernel_ram_end = 0x20000400 + 0x3fc00;
